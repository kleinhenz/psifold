...
from torchstruct.util import internal_coords, geometric_unit, dRMSD

def test_geometric_unit_RMSD():
    """
    test that internal_coords -> geometric_unit is the identity
    """
    batch_size = 10
...
def test_geometric_unit_dRMSD():
    """
    test that internal_coords -> geometric_unit is the identity up to
